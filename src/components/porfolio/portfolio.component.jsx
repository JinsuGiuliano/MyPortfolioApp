			...
			<div className="row">
				<div className="col-md-6">
					<div className="work-box">
							...
							<div className="row">
								<div className="col-sm-8">
									...
									<div className="w-more">
										...
										<span>
											React JS / React SAGAS / React REDUX / Firestore Cloud DB
											/ TypeScript / Stripe Payment
										</span>
										<br />
						...
						>
							<a
								href="https://github.com/JinsuGiuliano/gg_shop"
								target="_blank"
								rel="noreferrer"
							>
								<div
				...
				<div className="col-md-6">
					<div className="work-box">
								...
								<div className="col-sm-8">
									...
									<div className="w-more">
										...
										<span>
											...
											Users / Google Login / File Share with app / Profile Page
											/ Follow Other Users / Search Newest Posts
										</span>
										<br />
										<span className="w-ctegory">Future Features:</span>
										<span>
											comment posts / ONG Categories / Search Bar (Users, posts,
											Topics...)
										</span>
										<br />
										<span className="w-ctegory">Web Development</span> /{" "}
						...
						>
							<a
								href="https://github.com/JinsuGiuliano/ong_social"
								target="_blank"
								rel="noreferrer"
							>
								<div
